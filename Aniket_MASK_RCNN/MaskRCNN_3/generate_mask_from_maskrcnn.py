...
for data in all_json_annotations['data']:
    ...
    valid_image_name = "data_test_smear/"+file_name
    ...
    print("Image = img",float(1/len(get_all_masks)))
    # plt.imshow(img[:,:,0])
    # plt.show()
    # plt.imshow(img[:,:,1])
    # plt.show()
    ...
    final_masked_im = float(1/len(get_all_masks))*get_image
    ...
    for image in get_all_masks:
        ...
        final_masked_im = final_masked_im + float(1/len(get_all_masks))*image
