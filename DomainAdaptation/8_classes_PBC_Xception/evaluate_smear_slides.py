# Smear Slides Evaluation - Xception fine tuned 8 classes for DA
...
from tensorflow import keras
model = keras.models.load_model('classification_pbc_8_DA_cropped_xception_fine_tuned_100e.h5')
...
def cm_analysis(y_true, y_pred, labels, ymap=None, figsize=(10,10)):
    ...
    plt.savefig('confusion_matrix_Smear_Slides_DA_cropped_xception_fine_tuned_100e_eval_from_PBC.png')
    plt.savefig('confusion_matrix_Smear_Slides_DA_cropped_xception_fine_tuned_100e_eval_from_PBC.eps')
    #plt.show()

cm_analysis(y_test_list, y_pred_list, [i for i in rev_index] , ymap=rev_index, figsize=(10,10))


with open('report_Smear_Slides_DA_cropped_xception_fine_tuned_100e_eval_from_PBC.txt', 'w') as f:
