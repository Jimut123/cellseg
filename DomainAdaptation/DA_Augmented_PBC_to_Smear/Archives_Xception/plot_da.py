...
plt.yticks([i/100 for i in range(0, 355, 70)], fontsize=30)
...
plt.savefig('da_source_pbc_loss.eps',  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig('da_source_pbc_loss.png',  bbox_extra_artists=(lgd,), bbox_inches='tight')
...
plt.savefig('da_source_pbc_acc.eps',  bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig('da_source_pbc_acc.png',  bbox_extra_artists=(lgd,), bbox_inches='tight')
