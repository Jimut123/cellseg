# PBC Evaluate - By training Xception on Smear Slides Cropped
...
def cm_analysis(y_true, y_pred, labels, ymap=None, figsize=(10,10)):
    ...
    plt.savefig('confusion_matrix_pbc_8_DA_cropped_xception_fine_tuned_100e_evaluate_smear_slides.png')
    plt.savefig('confusion_matrix_pbc_8_DA_cropped_xception_fine_tuned_100e_evaluate_smear_slides.eps')
    #plt.show()

cm_analysis(y_test_list, y_pred_list, [i for i in rev_index] , ymap=rev_index, figsize=(10,10))


with open('report_pbc_8_DA_cropped_xception_fine_tuned_100e_evaluate_smear_slides.txt', 'w') as f:
