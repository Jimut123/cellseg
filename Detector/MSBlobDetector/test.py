...
for im_name in all_imgs:
    ...
    image = imgs
    image_gray = imgs
    blobs_log = blob_log(image_gray, max_sigma=70, num_sigma=30, threshold=0.001)
    ...
    blobs_dog = blob_dog(image_gray, max_sigma=80, threshold=0.001)
    blobs_dog[:, 2] = blobs_dog[:, 2] * sqrt(2)
    # max_dog_rad = max(blobs_dog)
    # print("Max log rad = ",max_dog_rad)

    blobs_doh = blob_doh(image_gray, max_sigma=50, threshold=0.001)
