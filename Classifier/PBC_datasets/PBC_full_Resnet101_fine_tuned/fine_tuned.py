...
hist_json_file = 'history_pbc_8_full_resnet101_fine_tuned_100e.json' 
with open(hist_json_file, mode='w') as f:
    hist_df.to_json(f)

# download the model in computer for later use
model.save('classification_pbc_8_full_resnet101_fine_tuned_100e.h5')

from tensorflow import keras
model = keras.models.load_model('classification_pbc_8_full_resnet101_fine_tuned_100e.h5')
...
def cm_analysis(y_true, y_pred, labels, ymap=None, figsize=(10,10)):
    ...
    plt.savefig('confusion_matrix_pbc_8_full_resnet101_fine_tuned_100e.png')
    plt.savefig('confusion_matrix_pbc_8_full_resnet101_fine_tuned_100e.eps')
    #plt.show()

cm_analysis(y_test_list, y_pred_list, [i for i in rev_index] , ymap=None, figsize=(10,10))


with open('report_pbc_8_full_resnet101_fine_tuned_100e.txt', 'w') as f:
