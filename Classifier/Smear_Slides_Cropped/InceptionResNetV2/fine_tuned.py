...
def cm_analysis(y_true, y_pred, labels, ymap=None, figsize=(10,10)):
    ...
    plt.savefig('confusion_matrix_Smear_10_cropped_InceptionResNetV2_fine_tuned_100e.png')
    plt.savefig('confusion_matrix_Smear_10_cropped_InceptionResNetV2_fine_tuned_100e.eps')
    #plt.show()

cm_analysis(y_test_list, y_pred_list, [i for i in rev_index] , ymap=rev_index, figsize=(10,10))


with open('report_Smear_10_cropped_InceptionResNetV2_fine_tuned_100e.txt', 'w') as f:
