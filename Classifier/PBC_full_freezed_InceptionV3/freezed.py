...
def cm_analysis(y_true, y_pred, labels, ymap=None, figsize=(10,10)):
    ...
    plt.savefig('confusion_matrix_pbc_8_full_inception_v3_100e.png')
    plt.savefig('confusion_matrix_pbc_8_full_inception_v3_100e.eps')
    #plt.show()

cm_analysis(y_test_list, y_pred_list, [i for i in rev_index] , ymap=None, figsize=(10,10))


with open('report_pbc_8_full_inception_v3_100e.txt', 'w') as f:
