...
hist_json_file = 'history_classification_model_v1_150e.json' 
with open(hist_json_file, mode='w') as f:
    hist_df.to_json(f)


model.save('classification_model_v1_blood.h5')


"""
from tensorflow import keras
model = keras.models.load_model('classification_model_v1_blood.h5')
