...
def cm_analysis(y_true, y_pred, labels, ymap=None, figsize=(10,10)):
    ...
    plt.savefig('confusion_matrix_pbc_8_InceptionResNetV2_100e.png')
    plt.savefig('confusion_matrix_pbc_8_InceptionResNetV2_100e.eps')
    #plt.show()

cm_analysis(y_test_list, y_pred_list, [i for i in rev_index] , ymap=None, figsize=(10,10))


with open('report_pbc_8_InceptionResNetV2.txt', 'w') as f:
